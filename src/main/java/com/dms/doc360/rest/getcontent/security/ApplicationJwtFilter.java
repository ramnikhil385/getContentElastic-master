 ...
 * 
 */
package com.dms.doc360.rest.getcontent.security;
...
import com.dms.doc360.rest.getcontent.utils.ApplicationContextProvider;
...
public class ApplicationJwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		try {
			ApplicationSecurityConfig applicationSecurityConfig = (ApplicationSecurityConfig) ApplicationContextProvider
					.getApplicationContext().getBean(Doc360Constants.BEAN_ID_APPLICATION_SECURITY_CONFIG);
			...
			JwtValidator jwtValidator = (JwtValidator) ApplicationContextProvider.getApplicationContext()
					.getBean(Doc360Constants.BEAN_ID_JWT_VALIDATOR);
			...
			request.setAttribute(Doc360Constants.REQUEST_ATTRIBUTE_DOC360_JWT_APPLICATION_CLAIMS, applicationClaims);
		} catch (Exception e) {
	...
	private String getMessageString(Throwable th) {
		...
		if (th != null) {
			...
			return Doc360Constants.EMPTY_STRING;
		}
	}
