...
@Slf4j
@Component
public class JwtValidator implements Doc360Constants {
	 ...
	 */
	public ApplicationClaims getApplicationClaims(String token) {
		...
		try {
			...
			if (claimsMap != null && !claimsMap.isEmpty()) {
				...
				ApplicationPreference appIdpreference = application.getPreferences();
